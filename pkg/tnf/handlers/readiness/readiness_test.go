...
func TestLiveness_GetIdentifier(t *testing.T) {
	...
	assert.Equal(t, identifier.ReadinessURLIdentifier, (*test).GetIdentifier())
}
...
func TestLiveness_ReelFirst(t *testing.T) {
	...
	expectedCommand := fmt.Sprintf("oc get pod -n %s %s -o  go-template-file=./readiness.gotemplate",
