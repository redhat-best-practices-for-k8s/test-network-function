...
---|---
Version|v1.0.0
Description|http://test-network-function.com/testcases/affiliated-certification/container-is-certified tests whether container images listed in tnf_config.yml have passed the Red Hat Container Certification Program (CCP).
Result Type|normative
...
---|---
Version|v1.0.0
Description|http://test-network-function.com/testcases/affiliated-certification/operator-is-certified tests whether CNF Operators listed in tnf_config.yml have passed the Red Hat Operator Certification Program (OCP).
Result Type|normative
