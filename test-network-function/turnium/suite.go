...
var (
	...
	// testPath is the file location of the nodes.json test case relative to the project root.
...
// createOc sets up a local shell expect.Expecter, checking errors along the way.
