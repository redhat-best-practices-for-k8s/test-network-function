...
```
### Cluster requirement
To run all the tests, OCP cluster should provide enough resources to drain nodes and reschdule pods. If that's not the case, then ``platform-alteration`` test suite should be skipped.
